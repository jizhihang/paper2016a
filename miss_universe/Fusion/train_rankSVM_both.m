function train_rankSVM_both(params, params_svm, svm_folder, svm_type)
...
if strcmp( svm_type, 'linear')
    ...
    save_svm_model = strcat( './', svm_folder, '/concFV_SFV_K', num2str(K), '_view', num2str(view), '_run', num2str(run), '.mat');
