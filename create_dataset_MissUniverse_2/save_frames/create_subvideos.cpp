...
main(int argc, char** argv)
{
  ...
  //Path @Home
  //const std::string path =  "/media/johanna/HD1T/codes/datasets_codes/EveningGownCompetition/MissUniverse2000/";
  
  
  //Path @UQ
  const std::string path = "/home/johanna-uq/codes/datasets_codes/MissUniverse/MissUniverse1999/";
  
  
  
  std::string video_name =  "OriginalVideo_1999.mp4";
