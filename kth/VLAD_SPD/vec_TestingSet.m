function vec_TestingSet (path, load_sub_path, list_pac_te, dim )
...
for i=1: length(list_pac_te)
    ...
    for c = 1:num_covs
        ...
        save_vec_cov =  strcat('./vec_TestingSet/vecSPD_', person, '_', action,  '_segm', num2str(c) , '.h5' );
