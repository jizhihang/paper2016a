function get_descriptors_BoW(list_pac_tr,list_pac_te,K,path, dim, Kmeans_folder, BoW_folder, folder_pp  )


% Getting descriptors for Training Set
for i=1:length(list_pac_tr)
    one_video_pac = {list_pac_tr{i,:}};
    get_BoW_histograms(one_video_pac, K,path, dim, Kmeans_folder, BoW_folder, folder_pp);
end
